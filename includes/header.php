...
<!--                         <div class="sidebar-widget">
                        ...
                        <div class="sidebar-widget">
                            ...
                            <div class="content clearfix">
                                ...
                                <div class="progress progress-bar-xs pull-left mt5 tip" title="<?php echo round($du/($ds/100)); ?>%">
                                    <div class="progress-bar progress-bar-success" style="width: <?php echo round($du/($ds/100)); ?>%;"></div>
                                </div>
                                <span class="percent pull-right"><?php echo round($du/($ds/100)); ?>%</span>
                                <div class="stat"><?php $class = min((int)log($df , $base) , count($si_prefix) - 1);echo sprintf('%1.2f' , $df / pow($base,$class)) ?>/<?php $class = min((int)log($ds , $base) , count($si_prefix) - 1); echo sprintf('%1.2f' , $ds / pow($base,$class)) . ' ' . $si_prefix[$class];?></div>
                            </div>
                        </div>
                        <!-- End .sidenav-widget -->
                        <div class="sidebar-widget">
