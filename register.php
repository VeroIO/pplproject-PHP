        ...
        <div class="container login-container">
            <div class="login-panel panel panel-default plain animated bounceIn">
                ...
                <div class="panel-body">
                    ...
                    <?}?>                  
                    <form class="form-horizontal mt0" action="<?php echo API ?>/api/register" id="register-form" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="input-group input-icon">
                                    <input type="password" name="repassword" id="repassword" class="form-control" placeholder="Repeat password">
                                    <span class="input-group-addon"><i class="icomoon-icon-key s16"></i></span> 
                                </div>
                            </div>
                        </div>
